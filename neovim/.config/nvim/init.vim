...
function! RipgrepFzf(query, fullscreen)
  let command_fmt = "rg --files --hidden --follow -g '!{.git}' | rg --smart-case %s | sed 's/$/:1:1:/'; rg --column --line-number --no-heading --color=always --smart-case --hidden --follow -g '!{.git}' %s || true"
