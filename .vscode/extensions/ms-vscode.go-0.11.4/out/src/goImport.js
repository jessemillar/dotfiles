...
function getImports(document) {
    return __awaiter(this, void 0, void 0, function* () {
        const options = { fileName: document.fileName, importsOption: goOutline_1.GoOutlineImportsOptions.Only, document };
...
function addImport(arg) {
    ...
    p.then(imp => {
        ...
        */
        util_1.sendTelemetryEvent('addImportCmd', { from: (arg && arg.from) || 'cmd' });
