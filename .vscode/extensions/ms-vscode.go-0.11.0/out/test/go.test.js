...
`;
    ...
    test('Error checking', (done) => {
        ...
        util_1.getGoVersion().then((version) => __awaiter(this, void 0, void 0, function* () {
    ...
    test('Gometalinter error checking', (done) => {
        util_1.getGoVersion().then((version) => __awaiter(this, void 0, void 0, function* () {
            ...
            const diagnostics = yield goCheck_1.check(vscode.Uri.file(errorsTestPath), config);
    ...
    test('Test diffUtils.getEditsFromUnifiedDiffStr', (done) => {
        ...
        diffPromise.then((filePatches) => __awaiter(this, void 0, void 0, function* () {
    ...
    test('Test diffUtils.getEdits', (done) => {
        ...
        vscode.workspace.openTextDocument(file1uri).then((textDocument) => __awaiter(this, void 0, void 0, function* () {
            try {
                const editor = yield vscode.window.showTextDocument(textDocument);
                yield editor.edit((editBuilder) => {
    ...
    test('Test Env Variables are passed to Tests', (done) => {
        ...
        vscode.workspace.openTextDocument(uri).then((document) => __awaiter(this, void 0, void 0, function* () {
            const editor = yield vscode.window.showTextDocument(document);
    ...
    test('Test Outline', (done) => {
        ...
        vscode.workspace.openTextDocument(uri).then(document => {
            const options = { document: document, fileName: document.fileName, importsOption: goOutline_1.GoOutlineImportsOptions.Include };
    ...
    test('Test Outline imports only', (done) => {
        const uri = vscode.Uri.file(path.join(fixturePath, 'outlineTest', 'test.go'));
        vscode.workspace.openTextDocument(uri).then(document => {
            const options = { document: document, fileName: document.fileName, importsOption: goOutline_1.GoOutlineImportsOptions.Only };
            goOutline_1.documentSymbols(options, null).then(outlines => {
                const packageSymbols = outlines.filter(x => x.kind === vscode.SymbolKind.Package);
                const imports = outlines[0].children.filter((x) => x.kind === vscode.SymbolKind.Namespace);
                const functions = outlines[0].children.filter((x) => x.kind === vscode.SymbolKind.Function);
    ...
    test('Test listPackages', (done) => {
        ...
        vscode.workspace.openTextDocument(uri).then(document => vscode.window.showTextDocument(document)
            .then((editor) => __awaiter(this, void 0, void 0, function* () {
    ...
    test('Replace vendor packages with relative path', (done) => {
        ...
        vendorSupportPromise.then((vendorSupport) => __awaiter(this, void 0, void 0, function* () {
            ...
            const listPkgPromise = vscode.workspace.openTextDocument(vscode.Uri.file(filePath)).then((document) => __awaiter(this, void 0, void 0, function* () {
                const editor = yield vscode.window.showTextDocument(document);
...
`;
        ...
        const uri = vscode.Uri.file(path.join(fixturePath, 'baseTest', 'test.go'));
        vscode.workspace.openTextDocument(uri).then((textDocument) => __awaiter(this, void 0, void 0, function* () {
            const editor = yield vscode.window.showTextDocument(textDocument);
            const promises = testCases.map(([position, expectedLabel, expectedDetail, expectedDoc]) => provider.provideCompletionItems(editor.document, position, null).then((items) => __awaiter(this, void 0, void 0, function* () {
