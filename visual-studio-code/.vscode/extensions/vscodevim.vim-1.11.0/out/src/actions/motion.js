...
const sneak_1 = require("./plugins/sneak");
/**
...
let MarkMovementBOL = class MarkMovementBOL extends baseMotion_1.BaseMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.currentRegisterMode = register_1.RegisterMode.LineWise;
            if (mark == null) {
                throw error_1.VimError.fromCode(error_1.ErrorCode.E20);
            }
...
let BackSpaceInNormalMode = class BackSpaceInNormalMode extends baseMotion_1.BaseMovement {
    constructor() {
        super(...arguments);
...
let MoveRightWithSpace = class MoveRightWithSpace extends baseMotion_1.BaseMovement {
    constructor() {
        super(...arguments);
        this.keys = [' '];
    }
    ...
    execActionWithCount(position, vimState, count) {
        return __awaiter(this, void 0, void 0, function* () {
            if (configuration_1.configuration.sneakReplacesF) {
                const pos = yield new sneak_1.SneakForward(this.keysPressed.concat('\n'), this.isRepeat).execActionWithCount(position, vimState, count);
                if (vimState.recordedState.operator && !baseMotion_1.isIMovement(pos)) {
                    return pos.getRight();
                }
                return pos;
            }
            ...
            if (!this.isRepeat &&
                (!vimState.recordedState.operator || !(baseMotion_1.isIMovement(result) && result.failed))) {
...
let MoveScreenLineEndNonBlank = class MoveScreenLineEndNonBlank extends MoveByScreenLine {
    ...
    execActionWithCount(position, vimState, count) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (baseMotion_1.isIMovement(pos)) {
...
let MoveUpByScreenLineMaintainDesiredColumn = class MoveUpByScreenLineMaintainDesiredColumn extends MoveByScreenLineMaintainDesiredColumn {
    constructor() {
        super(...arguments);
...
MoveUpByScreenLineMaintainDesiredColumn = __decorate([
    base_1.RegisterAction
], MoveUpByScreenLineMaintainDesiredColumn);
exports.MoveUpByScreenLineMaintainDesiredColumn = MoveUpByScreenLineMaintainDesiredColumn;
let MoveDownByScreenLineMaintainDesiredColumn = class MoveDownByScreenLineMaintainDesiredColumn extends MoveByScreenLineMaintainDesiredColumn {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Insert, mode_1.ModeName.Normal, mode_1.ModeName.Visual];
...
MoveDownByScreenLineMaintainDesiredColumn = __decorate([
    base_1.RegisterAction
], MoveDownByScreenLineMaintainDesiredColumn);
...
let MoveNextLineNonBlank = class MoveNextLineNonBlank extends baseMotion_1.BaseMovement {
    constructor() {
        super(...arguments);
        this.keys = ['\n'];
    }
...
let MoveNonBlankFirst = class MoveNonBlankFirst extends baseMotion_1.BaseMovement {
    ...
    execActionWithCount(position, vimState, count) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (count > textEditor_1.TextEditor.getLineCount()) {
                count = textEditor_1.TextEditor.getLineCount();
            }
...
let MoveToMatchingBracket = MoveToMatchingBracket_1 = class MoveToMatchingBracket extends baseMotion_1.BaseMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lineText = textEditor_1.TextEditor.getLineAt(position).text;
            const failure = { start: position, stop: position, failed: true };
            for (let col = position.character; col < lineText.length; col++) {
                const pairing = matcher_1.PairMatcher.pairings[lineText[col]];
                if (pairing && pairing.matchesWithPercentageMotion) {
                    // We found an opening char, now move to the matching closing char
                    return (matcher_1.PairMatcher.nextPairedChar(new position_1.Position(position.line, col), lineText[col]) || failure);
                }
            }
    ...
    execActionForOperator(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (baseMotion_1.isIMovement(result)) {
                if (result.failed) {
                    return result;
                }
                else {
    ...
    execActionWithCount(position, vimState, count) {
        const _super = Object.create(null, {
            execActionWithCount: { get: () => super.execActionWithCount }
        });
        return __awaiter(this, void 0, void 0, function* () {
...
class ArrowsInInsertMode extends baseMotion_1.BaseMovement {
    constructor() {
        super(...arguments);
