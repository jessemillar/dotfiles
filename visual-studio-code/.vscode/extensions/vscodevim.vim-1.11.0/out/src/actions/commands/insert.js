            ...
            if (char === '<BS>') {
                ...
                if (!selection.isEmpty) {
                    ...
                    if (position.character > 0 &&
                        line.length > 0 &&
                        line.match(/^\s+$/) &&
                        configuration_1.configuration.expandtab) {
...
let CommandInsertDigraph = class CommandInsertDigraph extends actions_1.BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const reverseDigraph = digraph
                ...
                .reverse()
                .join('');
            let charCodes = (digraphs_1.DefaultDigraphs[digraph] ||
                digraphs_1.DefaultDigraphs[reverseDigraph] ||
    ...
    doesActionApply(vimState, keysPressed) {
        ...
        return (chars in configuration_1.configuration.digraphs ||
            ...
            chars in digraphs_1.DefaultDigraphs ||
            reverseChars in digraphs_1.DefaultDigraphs);
    }
