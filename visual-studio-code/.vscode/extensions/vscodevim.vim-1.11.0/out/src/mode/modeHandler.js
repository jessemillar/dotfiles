    ...
    runAction(vimState, recordedState, action) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            ...
            const movement = action instanceof baseMotion_1.BaseMovement ? action : undefined;
    ...
    executeMovement(vimState, movement) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < vimState.cursors.length; i++) {
                ...
                else if (baseMotion_1.isIMovement(result)) {
                    if (result.failed) {
                        vimState.recordedState = new recordedState_1.RecordedState();
            ...
            for (const command of otherTransformations) {
                switch (command.type) {
                    ...
                    case 'macro':
                        ...
                        if (command.register === ':') {
                            yield commandLine_1.commandLine.Run(recordedMacro.commandString, vimState);
                        }
